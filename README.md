...
Requires Ruby 3.x. Install with `rbenv` or `brew install ruby`.

```bash
# Clone the repo and install dependencies
git clone https://github.com/[you]/jurms.git
cd jurms
bundle install

# Start local dev server (site available at http://localhost:4000)
